...
public class ModItems {
    ...
    public static final RegistryObject<Item> DRAGON_AXE = ITEMS.register("dragon_axe",
            () -> new AxeItem(ModItemTier.DRAGON, 6.5f, -3.0F, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));
    public static final RegistryObject<Item> DRAGON_PICKAXE = ITEMS.register("dragon_pickaxe",
            () -> new PickaxeItem(ModItemTier.DRAGON, 1, -2.8F, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));
    public static final RegistryObject<Item> DRAGON_SHOVEL = ITEMS.register("dragon_shovel",
            () -> new ShovelItem(ModItemTier.DRAGON, 1.5f, -3.0F, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));
    public static final RegistryObject<Item> DRAGON_HOE = ITEMS.register("dragon_hoe",
            () -> new HoeItem(ModItemTier.DRAGON, 0, -2.0F, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));

    public static final RegistryObject<Item> DRAGON_HELMET = ITEMS.register("dragon_helmet",
            () -> new ArmorItem(ModArmourMaterial.DRAGON, EquipmentSlotType.HEAD, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));
    public static final RegistryObject<Item> DRAGON_CHESTPLATE = ITEMS.register("dragon_chestplate",
            () -> new ArmorItem(ModArmourMaterial.DRAGON, EquipmentSlotType.CHEST, (new Item.Properties().tab(ModItemGroup.DEPTHS_OF_RUIN_TAB).rarity(Rarity.COMMON))));
